...
class DelayModel:
    ...
    def preprocess(
        ...
        """
        # Function to get the period of the day
        ...
        # Function to calculate time difference in min
        ...
        if target_column is None:
            return features[ten_features]
        
        if (target_column != "ALL"):
            features = features[ten_features]
    ...
    def fit(
        ...
        # Here I'm using XGBClassifier for more complex relationships in the data
